...
!(function (e, a) {
    ...
    var m = {
        ...
        d = location.href.replace("schoolguru-login.html", "");
    var s = (function () {
        function e(e, a) {
            this.modelPath = a || "" + d + "model.json";
        }
        return (
                            ...
                            case 1:
                                return (
                                    ...
                                    (u = i.tidy(function () {
                                        ...
                                        return i.image.nonMaxSuppression(e, p, a, 0.5, 0.5);
                                    })),
                                    (f = u.dataSync()),
                                    u.dispose(),
                                    i.setBackend(y),
                                    [2, this.buildDetectedObjects(d, m, o, p, f, c)]
                                );
                        }
                    });
                });
            ...
            (e.prototype.buildDetectedObjects = function (e, a, i, n, t, d) {
                for (var s = t.length, r = [], o = 0; o < s; o++) {
                    ...
                    var c = l[0] * a,
                        ...
                        u = l[2] * a,
                        f = l[3] * e;
                    (l[0] = y), (l[1] = c), (l[2] = f - y), (l[3] = u - c), r.push({ bbox: l, class: m[d[t[o]] + 1].displayName, score: n[t[o]] });
                }
                return r;
            }),
